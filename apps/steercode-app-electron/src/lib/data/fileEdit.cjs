...
var applyDiff = function (diff) { return __awaiter(void 0, void 0, void 0, function () {
...
var applyFileDiff = function (diff) { return __awaiter(void 0, void 0, void 0, function () {
    var isNewFile, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, fs_1.promises.access(diff.fileName, fs_1.promises.constants.F_OK)];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
            ...
            case 4:
                ...
                if (diff.head)
                    throw new Error('There is existing content for file that is supposed to be new, LLM probably used wrong file name');
                return [4 /*yield*/, fs_1.promises.writeFile(diff.fileName, diff.incoming, 'utf-8')];
            case 5:
                _a.sent();
                return [3 /*break*/, 8];
            case 6: return [4 /*yield*/, applyMergeDiff(diff)];
            case 7:
                _a.sent();
                _a.label = 8;
...
function printStringDifference(string1, string2) {
    var differences = [];
    __spreadArray(__spreadArray([], __read(string1), false), __read(string2), false).forEach(function (char, index) {
        if (string1[index] !== string2[index]) {
            differences.push("Index ".concat(index, ": ").concat(string1[index] || '-', " != ").concat(string2[index] || '-'));
        }
    });
    console.log(differences.length === 0
        ? 'The strings are identical.'
        : 'Differences found:');
    console.log(differences.join('\n'));
}
var applyMergeDiff = function (diff) { return __awaiter(void 0, void 0, void 0, function () {
    var content, flexibleHead, regex, firstMatch, secondMatch, newContent;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fs_1.promises.readFile(diff.fileName, 'utf-8')];
            case 1:
                content = _a.sent();
                flexibleHead = '\\s*' + diff.head.trim().replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '\\s*';
                regex = new RegExp(flexibleHead, 'g');
                firstMatch = regex.exec(content);
                if (!firstMatch) {
                    printStringDifference(content, diff.head);
                    throw new Error("The string '".concat(diff.head, "' was not found in the file."));
                }
                secondMatch = regex.exec(content);
                if (secondMatch) {
                    throw new Error("There is more than one occurrence of the string '".concat(diff.head, "' in the file."));
                }
                newContent = content.substring(0, firstMatch.index) +
                    diff.toMergeFormat() +
                    content.substring(firstMatch.index + diff.head.length);
                return [4 /*yield*/, fs_1.promises.writeFile(diff.fileName, newContent, 'utf-8')];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
